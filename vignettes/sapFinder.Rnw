...
\Rpackage{sapFinder} is developed to

\begin{enumerate}
\item annotate variation-associated database construction from public 
...
easyRun(vcf=vcf,annotation=annotation,refseq=refseq,
        ...
        itol=0.1, itolu="Daltons", alignment=1)
@
